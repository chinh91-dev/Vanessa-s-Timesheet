...
export function ContactCategoryManagement({ open, onClose }: ContactCategoryManagementProps) {
  const { userRole } = useAuth();
  const { data: categories, isLoading } = useAllContactCategories();
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="e.g., Hot Lead, Enterprise, Partner"
                    />
                  </div>
      ...
      <AlertDialog open={!!deleteConfirmId} onOpenChange={() => setDeleteConfirmId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete this category? This will remove it from all contacts.
